    ...
    <div className="welcomeTextContainer ">
      <article className='welLayout'>
          <header>
              ...
              <h1 className="title-brand txt-deg-primary welTile">La Casita De Papel</h1>
          </header>
          <article className=''>
              <h5 className='welSlogan'>¡Somos una micro-empresa comprometida con la sostenibilidad y la creatividad!</h5>
