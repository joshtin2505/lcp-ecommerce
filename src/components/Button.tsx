...
function Button({type, children, size, className = '', rounded, weight}: ButtonProps) {
    const button = tv({
    ...
    if (type === 'primary'){
        return (
            <button className={button({size, rounded, weight, className})}>{children}</button>
          )
    }
    else if (type === 'secondary'){
        return (
            <button className={button({size, rounded, weight, className})}>
                <span className="w-full h-full flex justify-center items-center">{children}</span>
            </button>
        )
    }
    else if (type === 'icon'){
        return (
            <button className={iconButton({size, rounded, className})}>{children}</button>
         )
    }
}
